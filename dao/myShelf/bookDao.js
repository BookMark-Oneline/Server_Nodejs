module.exports.registerBookInfo = async (
  connection,
  [user_id, title, img_url, author, publisher, isbn, total_page]
) => {
  try {
    const registerBookInfoQuery =
      "INSERT INTO BookInfo (title, img_url, author, publisher, isbn, total_page, status, total_reading_time, current_reading_page) VALUES (?, ?, ?, ?, ?, ?, 1, 0, 0);";
